...
import com.gowri.ElectricityBillingSystem.getNumberOfUnitsConsumedForCurrentMonth
...
class RestController {
    ...
    @RequestMapping("/getNumberOfUnitsForCurrentMonth")
    fun getNumberOfUnitsConsumedForCurrentMonth(@RequestBody user: User): User{
